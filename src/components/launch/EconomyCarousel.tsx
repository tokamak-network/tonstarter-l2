...
import EconomyOne from "./Economy/EconomyOne";
import EconomyTwo from "./Economy/EconomyTwo";
import EconomyThree from "./Economy/EconomyThree";
import EconomyFive from "./Economy/EconomyFive";
import EconomyFour from "./Economy/EconomyFour";
    ...
    <Flex
      ...
      <Flex
        ...
        <Flex
          ...
          <>
           <Flex onClick={() => setActiveIndex(0)}><EconomyOne/></Flex>
          <Flex onClick={() => setActiveIndex(1)}><EconomyTwo/></Flex>
          <Flex onClick={() => setActiveIndex(2)}><EconomyThree/></Flex>
          <Flex onClick={() => setActiveIndex(3)}><EconomyFour/></Flex>
          <Flex onClick={() => setActiveIndex(4)}><EconomyFive/></Flex></>
